...
/**
 * Используя массив объектов пользователей users (дальше в задании), напишите функции которые с помощью функциональных методов массивов (никаких for, splice и т. д.) выполняют следующие операции.
 */
