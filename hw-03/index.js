...
/**
1. Есть массив logins с логинами пользователей. 
2. Напишите скрипт добавления логина в массив logins. 
3. Добавляемый логин должен:
...
Напишите функцию isLoginValid(login), 

В которой проверьте: 
    - количество символов параметра login и 
      - верните true или false в зависимости от того, 
        - попадает ли длина параметра в заданный диапазон от 4-х до 16-ти символов включительно.

Создайте функцию isLoginUnique(allLogins, login), 

  - Которая принимает: 
    - логин и 
    - список всех логинов как параметры и 
...
Если логин не валиден, 
  ...
  - прекратить исполнение функции addLogin и вернуть строку 'Ошибка! Логин должен быть от 4 до 16 символов'
...
- addLogin добавляет или не добавляет логин в массив. 
  - При этом для проверок условия добавления используются результаты вызовов других функций - isLoginUnique и isLoginValid.
 */
